defmodule Fast.ValidFilesCaseTest do
  ...
  test inspect(&assert_files_exist/1) do
    ...
    assert_files_exist("test/valid_files_case/invalid_files/*.exs")
  end
  ...
  test inspect(&assert_files_valid/1) do
    ...
    assert_raise SyntaxError, ~r/test\/valid_files_case\/invalid_files\/invalid.exs:3:3/, fn ->
      assert_files_valid("test/valid_files_case/invalid_files/*.exs")
    end
  end
end
